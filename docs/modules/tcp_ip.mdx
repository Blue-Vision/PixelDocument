...
<VideoPlayer url='/videos/tcp_ip/tcp_ip_server.mp4' youtubeUrl='https://www.youtube.com/watch?v=ZHoEO5pSBbI' />
...
### Thử nghiệm đọc/ghi
Người dùng có thể thử nghiệm đọc/ghi dữ liệu từ server bằng cách sử dụng các nút bấm trong phần này. Các nút bấm sẽ gửi dữ liệu tới client và đọc dữ liệu nhận được từ phía client.
...
<VideoPlayer url='/videos/tcp_ip/tcp_ip_client.mp4' youtubeUrl='https://www.youtube.com/watch?v=BH_lc0k0TaY' />
